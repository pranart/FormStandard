...
namespace THSplit
{
    public class Spliter
    {
        ...
        public Spliter()
        {
            ...
            {
                dictionaryPath = "NeatLibrary.iOS.dictionary.txt";
            }
            else if(Device.RuntimePlatform == Device.Android)
            {
                dictionaryPath = "NeatLibrary.Droid.dictionary.txt";
            }
            else if (Device.RuntimePlatform == Device.UWP)
            {
                dictionaryPath = "NeatLibrary.UWP.dictionary.txt";
            }
            else
            {
                throw new PlatformNotSupportedException();
            }
            var _textStreamReader = new StreamReader(_assembly.GetManifestResourceStream(dictionaryPath));
